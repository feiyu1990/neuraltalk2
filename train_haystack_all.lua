...
cmd:option('-ix2word_file','coco/data.json','path to the json file containing ix_to_word')
cmd:option('-val_json_file','coco/data.json','..')
cmd:option('-train_json_file','coco/data.json','..')
cmd:option('-img_root','coco/data.json','..')
cmd:option('-mirror',false,'..')
...
-------------------------------------------------------------------------------
local loader = DataLoaderImg{h5_file = opt.input_h5, ix2word_file = opt.ix2word_file, val_json_file=opt.val_json_file, train_json_file=opt.train_json_file, img_root=opt.img_root}
...
local function eval_split(split, evalopt)
  ...
  while true do
    ...
    local data = loader:getBatch{batch_size = opt.batch_size, split = split, seq_per_img = opt.seq_per_img, mirror=opt.mirror}
